...
# Milestone 12B push-path non-regression, against staging after the 12C rollout.
#
...
staging_preflight "supabase_12b_staging_e2e" require_service_role
...
exec deno run \
  ...
  tool/supabase_12b_staging_e2e.ts "$@"
